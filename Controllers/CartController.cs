...
namespace Recepboyvat.ECommerceMVCWeb.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult AddToCart2(int Id2)
        {
            var product = db.Products.FirstOrDefault(i => i.Id == Id2);
        ...
        public ActionResult AddToCart3(int Id3)
        {
            var product = db.Products.FirstOrDefault(i => i.Id == Id3);
        ...
        public ActionResult Checkout(ShippingDetails entity)
        {
            ...
            {
                ModelState.AddModelError("UrunYokError", "Sepetinizde ürün bulunmamaktadir");
